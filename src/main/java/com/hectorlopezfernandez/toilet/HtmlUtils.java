...
public final class HtmlUtils {
	...
	private static Whitelist FEED_WHITELIST = Whitelist.basicWithImages();
	private static Whitelist INDEX_WHITELIST = Whitelist.none();

	public static String preprocessForFeeds(String html) {
		if (html == null || html.isEmpty()) return html;

		return Jsoup.clean(html, FEED_WHITELIST);
	}
	...
	public static String preprocessForSearchIndex(String html) {
		...
		System.out.println(processedContent);
		processedContent = Jsoup.clean(processedContent, INDEX_WHITELIST);
		System.out.println(processedContent);
